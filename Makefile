NAME=minishell
FILES=./src/main.o ./src/tokenizer/wordbreaker.o ./src/tokenizer/lexer.o ./src/sentences/pipes.o ./src/tokenizer/parser.o ./src/env/get_env.o ./src/env/utils.o ./src/export/export.o ./src/export/utils.o
