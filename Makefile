NAME=minishell
FILES=./src/main.o ./src/tokenizer/wordbreaker.o ./src/tokenizer/lexer.o ./src/sentences/pipes.o ./src/tokenizer/parser.o ./src/env/get_env.o ./src/env/utils.o ./src/env_management/export.o ./src/env_management/unset.o ./src/env_management/utils.o ./src/echo/echo.o ./src/exec/exec_child.o ./src/exec/exec_parent.o ./src/exec/prepare.o ./src/exec/utils.o ./src/exec/utils2.o ./src/utils.o ./src/cd/cd.o ./src/cd/utils.o ./src/cd/utils2.o ./src/flow/ambient_set.o ./src/flow/ambient_get.o ./src/flow/ambient_utils.o ./src/flow/program.o ./src/flow/utils.o ./src/flow/validations.o ./src/traitement/quote.o ./src/traitement/variable.o ./src/traitement/variable2.o ./src/builtin/exec.o ./src/pwd/pwd.o ./src/readline/readline.o ./src/signals_handler/signals_handler.o ./src/exit/exit.o
