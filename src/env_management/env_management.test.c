...
Test(ft_export, add_var_with_equal_and_no_value_env_line_counter, .init=redirect_all_stdout)
{
    char    *env[] = {
        "GDMSESSION=ubuntu",
        "DISPLAY=:0",
...
Test(ft_export, add_var_env_with_equal_and_no_value_find_var, .init=redirect_all_stdout)
{
    char    *env[] = {
        "GDMSESSION=ubuntu",
        "DISPLAY=:0",
    ...
    cr_assert_not_null(ft_strnstr(output, "RENATOAAA=", ft_strlen(output)), 
        "A variável RENATOAAA= não foi encontrada na saída do print_env");
}
...
Test(ft_export, invalid_key_check_error_and_return, .init=redirect_all_stdout)
{
    ...
    int ret = ft_export(&my_env, param);
...
Test(ft_export, add_multiple_vars_find_vars, .init=redirect_all_stdout)
{
    ...
    cr_assert_not_null(ft_strnstr(output, "RENATO=123", ft_strlen(output)), 
        "A variável RENATO=123 não foi encontrada na saída do export ordenado");
    cr_assert_not_null(ft_strnstr(output, "VICTOR=123", ft_strlen(output)), 
        "A variável VICTOR=123 não foi encontrada na saída do export ordenado");
    cr_assert_not_null(ft_strnstr(output, "MINISHELL=123", ft_strlen(output)), 
        "A variável MINISHELL=123 não foi encontrada na saída do export ordenado");
}
...
Test(ft_export, add_multiple_invalid_and_valid_vars_find_valids, .init=redirect_all_stdout)
{
    char    *env[] = {
        "GDMSESSION=ubuntu",
        "DISPLAY=:0",
...
Test(ft_unset, remove_var_try_to_find_var, .init=redirect_all_stdout)
{
    ...
    cr_assert_null(ft_strnstr(output, "SHLVL=1", ft_strlen(output)), 
        "A variável SHLVL não foi removida da lista");
}
...
//Chamada da função unset com varios argumentos buscando se as variaveis foram excluida


//Chamada da função unset com varios argumentos contando linha para ver se decrementou
/*Test(ft_unset, remove_multiples_var_line_counter, .init=redirect_all_stdout)
{
    char    *env[] = {
        "GDMSESSION=ubuntu",
        "DISPLAY=:0",
